	...
	function getquote(percent) {
		if (percent < 10) {
			...
			return "You&lsquo;re sort of Kiwi";
		} else if (percent < 40) {
			return "Based on that surname you&lsquo;re Kiwi enough. We think you&lsquo;re pushing it though but we&lsquo;ll give you a pass on this occasion.";
		} else if (percent < 50) {
